...
import com.badlogic.gdx.files.PlatformHelper;
...
public class FileHandle {
	...
	public InputStream read () {
		if (type == FileType.Classpath || (type == FileType.Internal && !file().exists())
			...
			InputStream input = PlatformHelper.getResourceAsStream(FileHandle.class, "/" + file.getPath().replace('\\', '/'));
	...
	public boolean exists () {
		...
		case Internal:
			...
			// Fall through.
		case Classpath:
			return PlatformHelper.hasResource(FileHandle.class, "/" + file.getPath().replace('\\', '/'));
		}
		return file().exists();
	}
