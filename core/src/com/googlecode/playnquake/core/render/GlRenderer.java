...
import com.googlecode.gl11emulation.GL11;
import com.googlecode.gl11emulation.GLDebug;
import com.googlecode.gl11emulation.MeshBuilder;
...
public class GlRenderer implements Renderer {
  ...
  /**
   * @see com.googlecode.playnquake.core.client.Renderer#CinematicSetPalette(byte[])
   */
  ...
  /**
   * @see com.googlecode.playnquake.core.client.Renderer#EndFrame()
   */
  ...
  /**
   * @see com.googlecode.playnquake.core.client.Renderer#AppActivate(boolean)
   */
...
//    }
   ...
   */
  /**
   * @see com.googlecode.playnquake.core.client.Renderer#DrawFadeScreen()
   */
