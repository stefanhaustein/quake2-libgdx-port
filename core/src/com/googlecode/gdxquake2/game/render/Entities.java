...
import com.googlecode.gdxquake2.game.client.EntityType;
...
import com.googlecode.gdxquake2.game.common.QuakeFiles;
import com.googlecode.gdxquake2.game.common.QuakeImage;
import com.googlecode.gdxquake2.game.game.Plane;
...
//		GlState.gl.glBegin(GL11.GL_TRIANGLE_FAN);
	...
	static void R_RenderView(RendererState fd) {
		...
		com.googlecode.gdxquake2.game.render.Particles.draw();
