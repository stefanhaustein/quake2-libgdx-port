...
import com.googlecode.gdxquake2.core.id.sound.*;
...
public class ClientState {
	...
	//
	com.googlecode.gdxquake2.core.id.render.Model model_draw[] =
	    new com.googlecode.gdxquake2.core.id.render.Model[Constants.MAX_MODELS];
