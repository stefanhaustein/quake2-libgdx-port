...
public class MonsterInsane {
    ...
    static EntityPainAdapter insane_pain = new EntityPainAdapter() {
    ...
    static Frame insane_frames_stand_normal[] = new Frame[] {
            new Frame(GameAI.ai_stand, 0, null),
            new Frame(GameAI.ai_stand, 0, null),
            new Frame(GameAI.ai_stand, 0, null),
            new Frame(GameAI.ai_stand, 0, null),
            new Frame(GameAI.ai_stand, 0, null),
            new Frame(GameAI.ai_stand, 0, insane_checkdown) };

    static MonsterMove insane_move_stand_normal = new MonsterMove(FRAME_stand60,
            FRAME_stand65, insane_frames_stand_normal, insane_stand);

    static Frame insane_frames_stand_insane[] = new Frame[] {
            new Frame(GameAI.ai_stand, 0, insane_shake),
            new Frame(GameAI.ai_stand, 0, null),
            new Frame(GameAI.ai_stand, 0, null),
            new Frame(GameAI.ai_stand, 0, null),
            new Frame(GameAI.ai_stand, 0, null),
    ...
    static MonsterMove insane_move_stand_insane = new MonsterMove(FRAME_stand65,
            FRAME_stand94, insane_frames_stand_insane, insane_stand);

    static Frame insane_frames_uptodown[] = new Frame[] {
            ...
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, insane_moan),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            ...
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 2.7f, null),
            new Frame(GameAI.ai_move, 4.1f, null),
            new Frame(GameAI.ai_move, 6f, null),
            new Frame(GameAI.ai_move, 7.6f, null),
            new Frame(GameAI.ai_move, 3.6f, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, insane_fist),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
    ...
    static MonsterMove insane_move_uptodown = new MonsterMove(FRAME_stand1,
            FRAME_stand40, insane_frames_uptodown, insane_onground);

    static Frame insane_frames_downtoup[] = new Frame[] {
            new Frame(GameAI.ai_move, -0.7f, null), // 41
            new Frame(GameAI.ai_move, -1.2f, null), // 42
            new Frame(GameAI.ai_move, -1.5f, null), // 43
            new Frame(GameAI.ai_move, -4.5f, null), // 44
            new Frame(GameAI.ai_move, -3.5f, null), // 45
            new Frame(GameAI.ai_move, -0.2f, null), // 46
            new Frame(GameAI.ai_move, 0, null), // 47
            new Frame(GameAI.ai_move, -1.3f, null), // 48
            new Frame(GameAI.ai_move, -3, null), // 49
            new Frame(GameAI.ai_move, -2, null), // 50
            new Frame(GameAI.ai_move, 0, null), // 51
            new Frame(GameAI.ai_move, 0, null), // 52
            new Frame(GameAI.ai_move, 0, null), // 53
            new Frame(GameAI.ai_move, -3.3f, null), // 54
            new Frame(GameAI.ai_move, -1.6f, null), // 55
            new Frame(GameAI.ai_move, -0.3f, null), // 56
            new Frame(GameAI.ai_move, 0, null), // 57
            new Frame(GameAI.ai_move, 0, null), // 58
            new Frame(GameAI.ai_move, 0, null) // 59
    };

    static MonsterMove insane_move_downtoup = new MonsterMove(FRAME_stand41,
            FRAME_stand59, insane_frames_downtoup, insane_stand);

    static Frame insane_frames_jumpdown[] = new Frame[] {
            new Frame(GameAI.ai_move, 0.2f, null),
            new Frame(GameAI.ai_move, 11.5f, null),
            new Frame(GameAI.ai_move, 5.1f, null),
            new Frame(GameAI.ai_move, 7.1f, null),
            new Frame(GameAI.ai_move, 0, null) };

    static MonsterMove insane_move_jumpdown = new MonsterMove(FRAME_stand96,
            FRAME_stand100, insane_frames_jumpdown, insane_onground);

    static Frame insane_frames_down[] = new Frame[] {
            new Frame(GameAI.ai_move, 0, null), // 100)
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            ...
            new Frame(GameAI.ai_move, 0, null),
            // 110)
            new Frame(GameAI.ai_move, -1.7f, null),
            new Frame(GameAI.ai_move, -1.6f, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, insane_fist),
            ...
            new Frame(GameAI.ai_move, 0, null),
            // 150
            new Frame(GameAI.ai_move, 0.5f, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, -0.2f, insane_scream),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0.2f, null),
            new Frame(GameAI.ai_move, 0.4f, null),
            new Frame(GameAI.ai_move, 0.6f, null),
            new Frame(GameAI.ai_move, 0.8f, null),
            new Frame(GameAI.ai_move, 0.7f, null),
            new Frame(GameAI.ai_move, 0, insane_checkup) // 160
    };

    static MonsterMove insane_move_down = new MonsterMove(FRAME_stand100,
            FRAME_stand160, insane_frames_down, insane_onground);

    static Frame insane_frames_walk_normal[] = new Frame[] {
            new Frame(GameAI.ai_walk, 0, insane_scream),
            new Frame(GameAI.ai_walk, 2.5f, null),
            new Frame(GameAI.ai_walk, 3.5f, null),
            new Frame(GameAI.ai_walk, 1.7f, null),
            new Frame(GameAI.ai_walk, 2.3f, null),
            new Frame(GameAI.ai_walk, 2.4f, null),
            new Frame(GameAI.ai_walk, 2.2f, null),
            new Frame(GameAI.ai_walk, 4.2f, null),
            new Frame(GameAI.ai_walk, 5.6f, null),
            new Frame(GameAI.ai_walk, 3.3f, null),
            new Frame(GameAI.ai_walk, 2.4f, null),
            new Frame(GameAI.ai_walk, 0.9f, null),
            new Frame(GameAI.ai_walk, 0, null) };

    static MonsterMove insane_move_walk_normal = new MonsterMove(FRAME_walk27,
            FRAME_walk39, insane_frames_walk_normal, insane_walk);

    static MonsterMove insane_move_run_normal = new MonsterMove(FRAME_walk27,
            FRAME_walk39, insane_frames_walk_normal, insane_run);

    static Frame insane_frames_walk_insane[] = new Frame[] {
            new Frame(GameAI.ai_walk, 0, insane_scream), // walk 1
            new Frame(GameAI.ai_walk, 3.4f, null), // walk 2
            new Frame(GameAI.ai_walk, 3.6f, null), // 3
            new Frame(GameAI.ai_walk, 2.9f, null), // 4
            new Frame(GameAI.ai_walk, 2.2f, null), // 5
            new Frame(GameAI.ai_walk, 2.6f, null), // 6
            new Frame(GameAI.ai_walk, 0, null), // 7
            new Frame(GameAI.ai_walk, 0.7f, null), // 8
            new Frame(GameAI.ai_walk, 4.8f, null), // 9
            new Frame(GameAI.ai_walk, 5.3f, null), // 10
            new Frame(GameAI.ai_walk, 1.1f, null), // 11
            new Frame(GameAI.ai_walk, 2, null), // 12
            new Frame(GameAI.ai_walk, 0.5f, null), // 13
            new Frame(GameAI.ai_walk, 0, null), // 14
            new Frame(GameAI.ai_walk, 0, null), // 15
            new Frame(GameAI.ai_walk, 4.9f, null), // 16
            new Frame(GameAI.ai_walk, 6.7f, null), // 17
            new Frame(GameAI.ai_walk, 3.8f, null), // 18
            new Frame(GameAI.ai_walk, 2, null), // 19
            new Frame(GameAI.ai_walk, 0.2f, null), // 20
            new Frame(GameAI.ai_walk, 0, null), // 21
            new Frame(GameAI.ai_walk, 3.4f, null), // 22
            new Frame(GameAI.ai_walk, 6.4f, null), // 23
            new Frame(GameAI.ai_walk, 5, null), // 24
            new Frame(GameAI.ai_walk, 1.8f, null), // 25
            new Frame(GameAI.ai_walk, 0, null) // 26
    };

    static MonsterMove insane_move_walk_insane = new MonsterMove(FRAME_walk1,
            FRAME_walk26, insane_frames_walk_insane, insane_walk);

    static MonsterMove insane_move_run_insane = new MonsterMove(FRAME_walk1,
            FRAME_walk26, insane_frames_walk_insane, insane_run);

    static Frame insane_frames_stand_pain[] = new Frame[] {
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
    ...
    static MonsterMove insane_move_stand_pain = new MonsterMove(FRAME_st_pain2,
            FRAME_st_pain12, insane_frames_stand_pain, insane_run);

    static Frame insane_frames_stand_death[] = new Frame[] {
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
    ...
    static MonsterMove insane_move_stand_death = new MonsterMove(FRAME_st_death2,
            FRAME_st_death18, insane_frames_stand_death, insane_dead);

    static Frame insane_frames_crawl[] = new Frame[] {
            new Frame(GameAI.ai_walk, 0, insane_scream),
            new Frame(GameAI.ai_walk, 1.5f, null),
            new Frame(GameAI.ai_walk, 2.1f, null),
            new Frame(GameAI.ai_walk, 3.6f, null),
            new Frame(GameAI.ai_walk, 2f, null),
            new Frame(GameAI.ai_walk, 0.9f, null),
            new Frame(GameAI.ai_walk, 3f, null),
            new Frame(GameAI.ai_walk, 3.4f, null),
            new Frame(GameAI.ai_walk, 2.4f, null) };

    static MonsterMove insane_move_crawl = new MonsterMove(FRAME_crawl1, FRAME_crawl9,
            insane_frames_crawl, null);

    static MonsterMove insane_move_runcrawl = new MonsterMove(FRAME_crawl1,
            FRAME_crawl9, insane_frames_crawl, null);

    static Frame insane_frames_crawl_pain[] = new Frame[] {
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
    ...
    static MonsterMove insane_move_crawl_pain = new MonsterMove(FRAME_cr_pain2,
            FRAME_cr_pain10, insane_frames_crawl_pain, insane_run);

    static Frame insane_frames_crawl_death[] = new Frame[] {
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
    ...
    static MonsterMove insane_move_crawl_death = new MonsterMove(FRAME_cr_death10,
            FRAME_cr_death16, insane_frames_crawl_death, insane_dead);

    static Frame insane_frames_cross[] = new Frame[] {
            new Frame(GameAI.ai_move, 0, insane_moan),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
    ...
    static MonsterMove insane_move_cross = new MonsterMove(FRAME_cross1, FRAME_cross15,
            insane_frames_cross, insane_cross);

    static Frame insane_frames_struggle_cross[] = new Frame[] {
            new Frame(GameAI.ai_move, 0, insane_scream),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
    ...
    static MonsterMove insane_move_struggle_cross = new MonsterMove(FRAME_cross16,
     ...
     */
    public static void SP_misc_insane(Entity self) {
        //	 static int skin = 0; //@@
