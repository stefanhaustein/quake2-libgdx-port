...
import com.googlecode.gdxquake2.core.id.game.adapters.EntityPainAdapter;
...
import com.googlecode.gdxquake2.core.id.util.*;
...
public class Entity {
    ...
    public void cleararealinks() {
        area = new ListNode(this);
    }

    /** Integrated entity state. */
    public EntityState s = new EntityState(this);
     ...
     */
    public ListNode area = new ListNode(this);
    ...
    public Entity goalentity = null;

    public Entity movetarget = null;
    ...
    public EntityTouchAdapter touch = null;

    public EntityUseAdapter use = null;
    ...
    public Entity chain = null;

    public Entity enemy = null;

    public Entity oldenemy = null;

    public Entity activator = null;

    public Entity groundentity = null;

    public int groundentity_linkcount;

    public Entity teamchain = null;

    public Entity teammaster = null;

    /** can go in client only. */
    public Entity mynoise = null;

    public Entity mynoise2 = null;
