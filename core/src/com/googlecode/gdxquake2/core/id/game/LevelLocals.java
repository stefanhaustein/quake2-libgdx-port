...
public class LevelLocals
{
	...
	public Entity sight_client; // changed once each frame for coop games

	public Entity sight_entity;
	public int sight_entity_framenum;
	
	public Entity sound_entity;
	public int sound_entity_framenum;
	
	public Entity sound2_entity;
	...
	public Entity current_entity; // entity running from G_RunFrame
