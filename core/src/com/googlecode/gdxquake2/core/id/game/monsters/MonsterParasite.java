...
public class MonsterParasite {
    ...
    static Frame parasite_frames_start_fidget[] = new Frame[] {
            new Frame(GameAI.ai_stand, 0, null),
            new Frame(GameAI.ai_stand, 0, null),
            new Frame(GameAI.ai_stand, 0, null),
            new Frame(GameAI.ai_stand, 0, null) };

    static MonsterMove parasite_move_start_fidget = new MonsterMove(FRAME_stand18,
            FRAME_stand21, parasite_frames_start_fidget, parasite_do_fidget);

    static Frame parasite_frames_fidget[] = new Frame[] {
            new Frame(GameAI.ai_stand, 0, parasite_scratch),
            new Frame(GameAI.ai_stand, 0, null),
            new Frame(GameAI.ai_stand, 0, null),
            new Frame(GameAI.ai_stand, 0, parasite_scratch),
            new Frame(GameAI.ai_stand, 0, null),
    ...
    static MonsterMove parasite_move_fidget = new MonsterMove(FRAME_stand22,
            FRAME_stand27, parasite_frames_fidget, parasite_refidget);

    static Frame parasite_frames_end_fidget[] = new Frame[] {
            new Frame(GameAI.ai_stand, 0, parasite_scratch),
            new Frame(GameAI.ai_stand, 0, null),
            new Frame(GameAI.ai_stand, 0, null),
            new Frame(GameAI.ai_stand, 0, null),
    ...
    static MonsterMove parasite_move_end_fidget = new MonsterMove(FRAME_stand28,
            FRAME_stand35, parasite_frames_end_fidget, parasite_stand);

    static Frame parasite_frames_stand[] = new Frame[] {
            new Frame(GameAI.ai_stand, 0, null),
            new Frame(GameAI.ai_stand, 0, null),
            new Frame(GameAI.ai_stand, 0, parasite_tap),
            new Frame(GameAI.ai_stand, 0, null),
            new Frame(GameAI.ai_stand, 0, parasite_tap),
            new Frame(GameAI.ai_stand, 0, null),
            new Frame(GameAI.ai_stand, 0, null),
    ...
    static MonsterMove parasite_move_stand = new MonsterMove(FRAME_stand01,
            FRAME_stand17, parasite_frames_stand, parasite_stand);

    static Frame parasite_frames_run[] = new Frame[] {
            new Frame(GameAI.ai_run, 30, null),
            new Frame(GameAI.ai_run, 30, null),
            new Frame(GameAI.ai_run, 22, null),
            new Frame(GameAI.ai_run, 19, null),
            new Frame(GameAI.ai_run, 24, null),
            new Frame(GameAI.ai_run, 28, null),
            new Frame(GameAI.ai_run, 25, null) };

    static MonsterMove parasite_move_run = new MonsterMove(FRAME_run03, FRAME_run09,
            parasite_frames_run, null);

    static Frame parasite_frames_start_run[] = new Frame[] {
            new Frame(GameAI.ai_run, 0, null),
            new Frame(GameAI.ai_run, 30, null), };

    static MonsterMove parasite_move_start_run = new MonsterMove(FRAME_run01,
            FRAME_run02, parasite_frames_start_run, parasite_run);

    static Frame parasite_frames_stop_run[] = new Frame[] {
    ...
    static MonsterMove parasite_move_stop_run = new MonsterMove(FRAME_run10,
            FRAME_run15, parasite_frames_stop_run, null);

    static Frame parasite_frames_walk[] = new Frame[] {
            new Frame(GameAI.ai_walk, 30, null),
            new Frame(GameAI.ai_walk, 30, null),
            new Frame(GameAI.ai_walk, 22, null),
            new Frame(GameAI.ai_walk, 19, null),
            new Frame(GameAI.ai_walk, 24, null),
            new Frame(GameAI.ai_walk, 28, null),
            new Frame(GameAI.ai_walk, 25, null) };

    static MonsterMove parasite_move_walk = new MonsterMove(FRAME_run03, FRAME_run09,
            parasite_frames_walk, parasite_walk);

    static Frame parasite_frames_start_walk[] = new Frame[] {
            new Frame(GameAI.ai_walk, 0, null),
            new Frame(GameAI.ai_walk, 30, parasite_walk) };

    static MonsterMove parasite_move_start_walk = new MonsterMove(FRAME_run01,
            FRAME_run02, parasite_frames_start_walk, null);

    static Frame parasite_frames_stop_walk[] = new Frame[] {
            new Frame(GameAI.ai_walk, 20, null),
            new Frame(GameAI.ai_walk, 20, null),
    ...
    static MonsterMove parasite_move_stop_walk = new MonsterMove(FRAME_run10,
            FRAME_run15, parasite_frames_stop_walk, null);

    static Frame parasite_frames_pain1[] = new Frame[] {
            ...
            new Frame(GameAI.ai_move, 16, null),
            new Frame(GameAI.ai_move, -6, null),
            new Frame(GameAI.ai_move, -7, null),
            new Frame(GameAI.ai_move, 0, null) };

    static MonsterMove parasite_move_pain1 = new MonsterMove(FRAME_pain101,
            FRAME_pain111, parasite_frames_pain1, parasite_start_run);

    static EntityPainAdapter parasite_pain = new EntityPainAdapter() {
    ...
    static Frame parasite_frames_drain[] = new Frame[] {
            new Frame(GameAI.ai_charge, 0, parasite_launch),
            new Frame(GameAI.ai_charge, 0, null),
            new Frame(GameAI.ai_charge, 15, parasite_drain_attack),
            // Target hits)
            new Frame(GameAI.ai_charge, 0, parasite_drain_attack), // drain)
            new Frame(GameAI.ai_charge, 0, parasite_drain_attack), // drain)
            new Frame(GameAI.ai_charge, 0, parasite_drain_attack), // drain)
            new Frame(GameAI.ai_charge, 0, parasite_drain_attack), // drain)
            new Frame(GameAI.ai_charge, -2, parasite_drain_attack), // drain)
            new Frame(GameAI.ai_charge, -2, parasite_drain_attack), // drain)
            new Frame(GameAI.ai_charge, -3, parasite_drain_attack), // drain)
            new Frame(GameAI.ai_charge, -2, parasite_drain_attack), // drain)
            new Frame(GameAI.ai_charge, 0, parasite_drain_attack), // drain)
            new Frame(GameAI.ai_charge, -1, parasite_drain_attack), // drain)
            new Frame(GameAI.ai_charge, 0, parasite_reel_in), // let go)
            new Frame(GameAI.ai_charge, -2, null),
            new Frame(GameAI.ai_charge, -2, null),
            new Frame(GameAI.ai_charge, -3, null),
            new Frame(GameAI.ai_charge, 0, null) };

    static MonsterMove parasite_move_drain = new MonsterMove(FRAME_drain01,
            FRAME_drain18, parasite_frames_drain, parasite_start_run);

    static Frame parasite_frames_break[] = new Frame[] {
            new Frame(GameAI.ai_charge, 0, null),
            new Frame(GameAI.ai_charge, -3, null),
            ...
            new Frame(GameAI.ai_charge, 0, null),
            /* airborne */
            new Frame(GameAI.ai_charge, 0, null), /* slides */
            new Frame(GameAI.ai_charge, 0, null), /* slides */
            new Frame(GameAI.ai_charge, 0, null), /* slides */
            new Frame(GameAI.ai_charge, 0, null), /* slides */
    ...
    static MonsterMove parasite_move_break = new MonsterMove(FRAME_break01,
    ...
    static Frame parasite_frames_death[] = new Frame[] {
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
