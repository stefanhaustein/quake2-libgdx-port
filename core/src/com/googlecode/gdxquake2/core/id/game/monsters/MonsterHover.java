...
public class MonsterHover {
    ...
    static EntityPainAdapter hover_pain = new EntityPainAdapter() {
    ...
    static Frame hover_frames_stand[] = new Frame[] {
    ...
    static MonsterMove hover_move_stand = new MonsterMove(FRAME_stand01, FRAME_stand30,
            hover_frames_stand, null);

    static Frame hover_frames_stop1[] = new Frame[] {
    ...
    static MonsterMove hover_move_stop1 = new MonsterMove(FRAME_stop101, FRAME_stop109,
            hover_frames_stop1, null);

    static Frame hover_frames_stop2[] = new Frame[] {
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
    ...
    static MonsterMove hover_move_stop2 = new MonsterMove(FRAME_stop201, FRAME_stop208,
            hover_frames_stop2, null);

    static Frame hover_frames_takeoff[] = new Frame[] {
            new Frame(GameAI.ai_move, 0, null),
    ...
    static MonsterMove hover_move_takeoff = new MonsterMove(FRAME_takeof01,
            FRAME_takeof30, hover_frames_takeoff, null);

    static Frame hover_frames_pain3[] = new Frame[] {
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
    ...
    static MonsterMove hover_move_pain3 = new MonsterMove(FRAME_pain301, FRAME_pain309,
            hover_frames_pain3, hover_run);

    static Frame hover_frames_pain2[] = new Frame[] {
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
    ...
    static MonsterMove hover_move_pain2 = new MonsterMove(FRAME_pain201, FRAME_pain212,
            hover_frames_pain2, hover_run);

    static Frame hover_frames_pain1[] = new Frame[] {
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 2, null),
    ...
    static MonsterMove hover_move_pain1 = new MonsterMove(FRAME_pain101, FRAME_pain128,
            hover_frames_pain1, hover_run);

    static Frame hover_frames_land[] = new Frame[] { new Frame(
            GameAI.ai_move, 0, null) };

    static MonsterMove hover_move_land = new MonsterMove(FRAME_land01, FRAME_land01,
            hover_frames_land, null);

    static Frame hover_frames_forward[] = new Frame[] {
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
    ...
    static MonsterMove hover_move_forward = new MonsterMove(FRAME_forwrd01,
            FRAME_forwrd35, hover_frames_forward, null);

    static Frame hover_frames_walk[] = new Frame[] {
    ...
    static MonsterMove hover_move_walk = new MonsterMove(FRAME_forwrd01,
            FRAME_forwrd35, hover_frames_walk, null);

    static Frame hover_frames_run[] = new Frame[] {
    ...
    static MonsterMove hover_move_run = new MonsterMove(FRAME_forwrd01, FRAME_forwrd35,
            hover_frames_run, null);

    static Frame hover_frames_death1[] = new Frame[] {
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
    ...
    static MonsterMove hover_move_death1 = new MonsterMove(FRAME_death101,
            FRAME_death111, hover_frames_death1, hover_dead);

    static Frame hover_frames_backward[] = new Frame[] {
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
    ...
    static MonsterMove hover_move_backward = new MonsterMove(FRAME_backwd01,
            FRAME_backwd24, hover_frames_backward, null);

    static Frame hover_frames_start_attack[] = new Frame[] {
            new Frame(GameAI.ai_charge, 1, null),
            new Frame(GameAI.ai_charge, 1, null),
            new Frame(GameAI.ai_charge, 1, null) };

    static MonsterMove hover_move_start_attack = new MonsterMove(FRAME_attak101,
            FRAME_attak103, hover_frames_start_attack, hover_attack);

    static Frame hover_frames_attack1[] = new Frame[] {
            new Frame(GameAI.ai_charge, -10, hover_fire_blaster),
            new Frame(GameAI.ai_charge, -10, hover_fire_blaster),
            new Frame(GameAI.ai_charge, 0, hover_reattack), };

    static MonsterMove hover_move_attack1 = new MonsterMove(FRAME_attak104,
            FRAME_attak106, hover_frames_attack1, null);

    static Frame hover_frames_end_attack[] = new Frame[] {
            new Frame(GameAI.ai_charge, 1, null),
            new Frame(GameAI.ai_charge, 1, null) };

    static MonsterMove hover_move_end_attack = new MonsterMove(FRAME_attak107,
     ...
     * Trigger_Spawn Sight
     */
    public static void SP_monster_hover(Entity self) {
