...
public class MonsterSupertank {
    ...
    static Frame supertank_frames_stand[] = new Frame[] {
    ...
    static Frame supertank_frames_run[] = new Frame[] {
            new Frame(GameAI.ai_run, 12, TreadSound),
    ...
    static MonsterMove supertank_move_run = new MonsterMove(FRAME_forwrd_1,
    ...
    static Frame supertank_frames_forward[] = new Frame[] {
            new Frame(GameAI.ai_walk, 4, TreadSound),
    ...
    static Frame supertank_frames_turn_right[] = new Frame[] {
            new Frame(GameAI.ai_move, 0, TreadSound),
    ...
    static MonsterMove supertank_move_turn_right = new MonsterMove(FRAME_right_1,
            FRAME_right_18, supertank_frames_turn_right, supertank_run);

    static Frame supertank_frames_turn_left[] = new Frame[] {
            new Frame(GameAI.ai_move, 0, TreadSound),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
    ...
    static MonsterMove supertank_move_turn_left = new MonsterMove(FRAME_left_1,
            FRAME_left_18, supertank_frames_turn_left, supertank_run);

    static Frame supertank_frames_pain3[] = new Frame[] {
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null) };

    static MonsterMove supertank_move_pain3 = new MonsterMove(FRAME_pain3_9,
            FRAME_pain3_12, supertank_frames_pain3, supertank_run);

    static Frame supertank_frames_pain2[] = new Frame[] {
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null) };

    static MonsterMove supertank_move_pain2 = new MonsterMove(FRAME_pain2_5,
            FRAME_pain2_8, supertank_frames_pain2, supertank_run);

    static Frame supertank_frames_pain1[] = new Frame[] {
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null) };

    static MonsterMove supertank_move_pain1 = new MonsterMove(FRAME_pain1_1,
            FRAME_pain1_4, supertank_frames_pain1, supertank_run);

    static Frame supertank_frames_death1[] = new Frame[] {
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
    ...
    static MonsterMove supertank_move_death = new MonsterMove(FRAME_death_1,
            FRAME_death_24, supertank_frames_death1, supertank_dead);

    static Frame supertank_frames_backward[] = new Frame[] {
            new Frame(GameAI.ai_walk, 0, TreadSound),
    ...
    static MonsterMove supertank_move_backward = new MonsterMove(FRAME_backwd_1,
            FRAME_backwd_18, supertank_frames_backward, null);

    static Frame supertank_frames_attack4[] = new Frame[] {
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
    ...
    static MonsterMove supertank_move_attack4 = new MonsterMove(FRAME_attak4_1,
            FRAME_attak4_6, supertank_frames_attack4, supertank_run);

    static Frame supertank_frames_attack3[] = new Frame[] {
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
    ...
    static MonsterMove supertank_move_attack3 = new MonsterMove(FRAME_attak3_1,
            FRAME_attak3_27, supertank_frames_attack3, supertank_run);

    static Frame supertank_frames_attack2[] = new Frame[] {
            ...
            new Frame(GameAI.ai_charge, 0, null),
            new Frame(GameAI.ai_charge, 0, null),
            new Frame(GameAI.ai_charge, 0, supertankRocket),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, supertankRocket),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, supertankRocket),
            new Frame(GameAI.ai_move, 0, null),
    ...
    static Frame supertank_frames_attack1[] = new Frame[] {
            new Frame(GameAI.ai_charge, 0, supertankMachineGun),
            new Frame(GameAI.ai_charge, 0, supertankMachineGun),
            new Frame(GameAI.ai_charge, 0, supertankMachineGun),
            new Frame(GameAI.ai_charge, 0, supertankMachineGun),
            new Frame(GameAI.ai_charge, 0, supertankMachineGun),
    ...
    static MonsterMove supertank_move_attack1 = new MonsterMove(FRAME_attak1_1,
            FRAME_attak1_6, supertank_frames_attack1, supertank_reattack1);

    static Frame supertank_frames_end_attack1[] = new Frame[] {
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
            new Frame(GameAI.ai_move, 0, null),
    ...
    static MonsterMove supertank_move_end_attack1 = new MonsterMove(FRAME_attak1_7,
            FRAME_attak1_20, supertank_frames_end_attack1, supertank_run);

    static EntityPainAdapter supertank_pain = new EntityPainAdapter() {
