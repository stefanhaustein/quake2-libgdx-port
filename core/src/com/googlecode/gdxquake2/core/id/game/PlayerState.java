...
public class PlayerState {
	...
	public PlayerMoveState pmove= new PlayerMoveState(); // for prediction
	...
	/** Clones the object.*/
	public PlayerState getClone() {
		return new PlayerState().set(this);
	}

	/** Copies the player state data. */
	public PlayerState set(PlayerState from) {
